...
const FormInput = forwardRef(({type, placeholder, onChange, onBlur, error, label, name, children}, ref) => {
  ...
  return (
    ...
    <label
      ...
      type={type} placeholder={placeholder} ref={ref} onChange={onChange} onBlur={onBlur} name={name}/>
      {children}
    </div>
  )
})
